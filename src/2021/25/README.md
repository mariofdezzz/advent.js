...
Eso sí, hay que tener cuidado 😶 y sólo hacer los movimientos correctos para comer algo. Por eso, el ratón, que se ha visto _los vídeos de midudev_, va a crear una función para saber si su próximo movimiento es correcto o no ✅.
